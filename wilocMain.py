...
def createStatisticsReport():
    try:
        ...
        strToSendStatistics.append(blackLen[2])
        strToSendStatistics.append(blackLen[3])
        strToSendStatistics.append(struct.pack(">I", globalVars.scheduler_version)[3])
        strToSendStatistics.append(struct.pack(">I", globalVars.comms_version)[3])
        strToSendStatistics.append(struct.pack(">I", globalVars.main_version)[3])
        strToSendStatistics.append(struct.pack(">I", globalVars.loc_version)[3])
